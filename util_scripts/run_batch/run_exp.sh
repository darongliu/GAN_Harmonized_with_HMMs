...
do
    ...
    do
        ...
        python $dir/process.py --config ./src/GAN-based-model/config.yaml --gan_gumbel $gan_gumbel --intra_gumbel $intra_gumbel --output $config_path
        ./run.sh $config_path ${name}_
    done
done
